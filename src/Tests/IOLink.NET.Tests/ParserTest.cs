...
public class ParserTest
{
    ...
    public void ShouldParseIODDDeviceIdentity(
        string path,
    ...
    public void ShouldParseIODDDeviceFunctionUserInterface(
        string path,
        bool hasMenus,
    ...
    public void ShouldParseIODDExternalTextCollection(
        string path,
        int externalTextCollectionTextDefinitionCount
    )
    {
        IODDParser parser = new();
        var device = parser.Parse(XElement.Load(path));
