...
public class IODDPortReaderTests
{
    ...
    public async Task CanInitializeForPortAsync(
        ushort vendorId,
        uint deviceId,
        string productId,
        string vendorName,
    ...
    {
        var (portReader, ioddProvider, masterConnection) = PreparePortReader(
            vendorId,
            deviceId,
            productId,
            vendorName,
    ...
    public async Task CanReadConvertedProcessDataInWithConditionAsync()
    {
        ...
        targetItem.ShouldNotBe(default); // This should pass if the item exists
        targetItem.Item2.ShouldBe(0);
    }
    ...
    public async Task CanReadConvertedParameterAsync(
        ushort vendorId,
        uint deviceId,
        string productId,
        string vendorName,
