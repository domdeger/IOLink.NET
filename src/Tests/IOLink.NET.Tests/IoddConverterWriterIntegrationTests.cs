...
public class IoddConverterWriterIntegrationTests
{
    ...
    public void ConvertToBytes_RealDeviceProcessData_ShouldRoundTripCorrectly()
    {
        ...
        var device = parser.Parse(
            XElement.Load("TestData/Balluff-BISM4A308240107S4-CCM-20210928-IODD1.1.xml")
        );
        ...
        var convertedObjects =
            converter.Convert(convertibleType, originalData) as IEnumerable<(string, object)>;
    ...
    public void ConvertToBytes_SimpleRecordData_ShouldMatchExpectedFormat()
    {
        ...
        var testRecord = new ParsableRecord(
            "TestRecord",
            8,
            true,
            new[] { recordItem1, recordItem2 }
        );
            ...
            new[]
            {
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Device_Temp",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Device_Temp",
                    96,
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Minimum_Device_Temp_Since_Startup",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Minimum_Device_Temp_Since_Startup",
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Maximum_Device_Temp_Since_Startup",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Maximum_Device_Temp_Since_Startup",
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Minimum_Device_Temp_Lifetime",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Minimum_Device_Temp_Lifetime",
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Maximum_Device_Temp_Lifetime",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Maximum_Device_Temp_Lifetime",
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Minimum_Device_Temp_Since_Reset",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Minimum_Device_Temp_Since_Reset",
                ...
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef(
                        "TI_VAR_Device_Temp_Maximum_Device_Temp_Since_Reset",
                        KindOfSimpleType.Integer,
                        16
                    ),
                    "TI_VAR_Device_Temp_Maximum_Device_Temp_Since_Reset",
    ...
    public void ConvertToBytes_MixedDataTypes_ShouldHandleCorrectly()
    {
        ...
        var testRecord = new ParsableRecord(
            ...
            {
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("intField", KindOfSimpleType.Integer, 16),
                    "intField",
                    0,
                    1
                ),
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("uintField", KindOfSimpleType.UInteger, 8),
                    "uintField",
                    16,
                    2
                ),
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("boolField", KindOfSimpleType.Boolean, 1),
                    "boolField",
                    24,
                    3
                ),
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("smallUint", KindOfSimpleType.UInteger, 8),
                    "smallUint",
                    25,
                    4
                ),
    ...
    public void ConvertToBytes_EdgeCaseBitLengths_ShouldHandleCorrectly()
    {
        ...
        var testRecord = new ParsableRecord(
            ...
            {
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("field1", KindOfSimpleType.UInteger, 5),
                    "field1",
                    0,
                    1
                ),
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("field2", KindOfSimpleType.UInteger, 3),
                    "field2",
                    5,
                    2
                ),
                new ParsableRecordItem(
                    new ParsableSimpleDatatypeDef("field3", KindOfSimpleType.UInteger, 5),
                    "field3",
                    8,
                    3
                ),
