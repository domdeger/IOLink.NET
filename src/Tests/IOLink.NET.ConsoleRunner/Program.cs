...
var ioddUserInterfaceReader = new IODDUserInterfaceConverter(portReader);

var convertedUI = ioddUserInterfaceReader.Convert();

await convertedUI.SpecialistRoleMenu.ReadAsync(default);
Console.WriteLine("User Interface converted successfully.");
