...
public class IoddComplexWriterTests
{
    ...
    public void WriteRecordType_ComplexRecord_ShouldHandleMultipleFields()
    {
        ...
        var recordType = new ParsableRecord("sensorData", 25, true, new[] { field1, field2, field3 });
        var values = new (string key, object value)[] 
        {
            ("temperature", 250),
            ("humidity", 65),
    ...
    public void WriteArrayType_WithDifferentLengths_ShouldHandleCorrectly(int length, byte[] expectedValues)
    {
        // Arrange
        var elementType = new ParsableSimpleDatatypeDef("element", KindOfSimpleType.UInteger, 8);
    ...
    public void WriteRecordType_WithBitPackedFields_ShouldHandleOffsets()
    {
        ...
        var recordType = new ParsableRecord("packedRecord", 8, true, new[] { field1, field2, field3 });
        var values = new (string key, object value)[] 
        {
            ("field1", 5), // 101
            ("field2", 2), // 10
    ...
    {
        public TestUnsupportedComplexType() : this("test", true) { }
    }
}
