...
public class PortReaderBuilder
{
    ...
    public PortReaderBuilder WithDeviceDefinitionProvider(IDeviceDefinitionProvider deviceDefinitionProvider)
    {
    ...
    public IODDPortReader Build()
    {
        ...
        return new IODDPortReader(_masterConnection, _deviceDefinitionProvider, _ioddDataConverter, _typeResolverFactory);
    }
}