...
public class IfmIotCoreMasterConnection : IMasterConnection
{
    ...
    )
    {
        ...
        var masterCycleTimeActualPath = IfmIoTCoreServicePathBuilder.PortMasterCycleTimeActualPath(
            portNumber
        );
        ...
        var deviceInfo = new DeviceInformation(
            resp.Data[vendorIdPath].Data.Deserialize<ushort>(),
        ...
        var portStatus =
            status == IfmIoTCorePortStatus.NotConnected
